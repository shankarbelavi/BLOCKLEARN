...
const LearnerSessionBookingPage = () => {
              ...
              <button
                onClick={() => {
                  if (selectedMentor && selectedSkill) {
                    ...
                    const deterministicId = `session_${selectedMentor.id}_${currentUser.id}_${selectedSkill.id}`;
...
export default LearnerSessionBookingPage;